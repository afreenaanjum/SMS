...
router.post('/sms/session/create', authenticateUser, sessionController.createSession)
router.post('/sms/session/:id', authenticateUser, sessionController.getSessionDetails)
router.put('/sms/session/:id', authenticateUser, sessionController.updateSessionDetails)
